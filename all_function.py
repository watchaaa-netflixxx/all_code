...
def skeleton(class_int, Vid_Folder_path, skeleton_output_path):  # 작동 모름

    # class_int = 0~4                       (class_model 함수 반환값)
    # Vid_Folder_path = '../Vid_Folder/'    (15초 영상 있는 폴더)
    # skeleton_output_path = '../MVid_Folder/'  (skeleton 영상 있는 폴더)
    ...
    # skeleton only video 파일 저장하기
    skeleton_output_path = Vid_Folder_path + '15s.mp4'
